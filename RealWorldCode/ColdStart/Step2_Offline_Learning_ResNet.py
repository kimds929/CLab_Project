...
save_file_name_base = f"Real_Alg4_pathtime_var_weights_ResNet_V3"
...
# model define -----------------------------------------------------------------------------
# from module.Module_TorchModel import BaroNowResNet_V3, BaroNowTransformer_V2

model = BaroNowResNet_V3(**hyper_parmas_dict, n_output=10)
...
for epoch in range(num_epochs):
    ...
    # save_file_name_base = f"Real_Alg4_pathtime_var_weights_ResNet_V2"
